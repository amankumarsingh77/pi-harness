      ...
      {active === "log" && (
        <Overlay onClose={() => setActive(null)}>
          <aside
            ...
            className="absolute top-0 right-0 flex h-full w-[min(620px,100vw)] flex-col overflow-hidden border-l border-line-strong bg-[#101217] shadow-[-28px_0_80px_rgba(0,0,0,0.45)]"
          >

...
import { PreflightProgress } from "@/components/plan/preflight-progress";
...
export default async function PlanPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      ...
      {/* Preflight strip — only renders when there's something to show. Once
          all 7 + claim-verifier are done it collapses to a one-line summary. */}
      <PreflightProgress research={bundle.research} events={bundle.events} />

      <main className="grid min-h-[calc(100vh-48px-80px-44px)] grid-cols-[1.4fr_1fr]">
        <article className="overflow-auto border-r border-line px-7 py-5.5">
        ...
        <aside className="overflow-auto px-7 py-5.5">
